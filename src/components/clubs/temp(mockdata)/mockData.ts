...
export const MOCK_POSTS: Record<string, ClubPost[]> = {
  ...
  "club-003": [{ id: "p5", author: "Riley Okonkwo", authorAvatar: "https://i.pravatar.cc/40?img=9",  content: "IEEEXtreme registration submitted! Fielding 3 teams this year. Practice starts next week — DM if you want a spot.", createdAt: "2025-02-19T13:00:00Z", likes: 27, liked: false, comments: [] }],
  "club-004": [
  ...
  "club-005": [{ id: "p8",  author: "Avery Johnson", authorAvatar: "https://i.pravatar.cc/40?img=15", content: "Sign circle this Friday at 5PM in the Student Union! Covering numbers, colors, and introductions. Perfect for day-one beginners 🤟", createdAt: "2025-02-18T10:00:00Z", likes: 19, liked: false, comments: [] }],
  "club-006": [{ id: "p9",  author: "Cam Estrada",   authorAvatar: "https://i.pravatar.cc/40?img=17", content: "Soccer bracket is LIVE for Spring Intramurals! 16 teams registered. Games start March 3rd. Schedule is on Discord ⚽", createdAt: "2025-02-22T09:00:00Z", likes: 44, liked: false, comments: [] }],
  "club-007": [{ id: "p10", author: "Ellis Grant",   authorAvatar: "https://i.pravatar.cc/40?img=20", content: "Suspension geometry finalized 🔧 Aero package goes to the machine shop next week. On track for Formula SAE in May — crunch mode engaged!", createdAt: "2025-02-23T14:30:00Z", likes: 38, liked: false, comments: [{ id: "c4", author: "Finley Hayes", text: "Let's gooo! 🏎️" }] }],
  "club-008": [
  ...
  "club-009": [{ id: "p13", author: "Jake Miller", authorAvatar: "https://i.pravatar.cc/40?img=26", content: "Rush Week is officially HERE 🏛️ Come out to our mixer tonight at 7PM — food, games, meet the brotherhood. No pressure.", createdAt: "2025-02-21T12:00:00Z", likes: 29, liked: false, comments: [] }],
  "club-010": [{ id: "p14", author: "Luna Clarke", authorAvatar: "https://i.pravatar.cc/40?img=29", content: "Spring issue submissions OPEN ✍️ Fiction (under 3k words), poetry, creative nonfiction — due March 15. Submit via the link in bio.", createdAt: "2025-02-19T11:00:00Z", likes: 33, liked: false, comments: [{ id: "c6", author: "Mia Flores", text: "Finally submitting my short story!" }] }],
  "club-011": [{ id: "p15", author: "Noah Carter", authorAvatar: "https://i.pravatar.cc/40?img=31", content: "2nd place at the CSUN Case Competition! Judges loved our go-to-market strategy. On to regionals 📈", createdAt: "2025-02-22T15:00:00Z", likes: 47, liked: false, comments: [] }],
  "club-012": [{ id: "p16", author: "Priya Nair",  authorAvatar: "https://i.pravatar.cc/40?img=33", content: "Sorority Recruitment starts next week! 💗 Open house Tuesday at 6PM — meet the sisters, hear about our philanthropy, ask anything.", createdAt: "2025-02-23T10:00:00Z", likes: 52, liked: false, comments: [{ id: "c7", author: "Quinn Adams", text: "So excited to meet everyone!" }] }],
};
...
export const MOCK_EVENTS: Record<string, ClubEvent[]> = {
  ...
  "club-004": [{ id: "e7", title: "Spring Game Jam 2025", description: "48-hour solo or team jam. Theme: LOOP. Judged on creativity and polish.", date: "2025-03-14", time: "6:00 PM", location: "Jacaranda Hall 2502", rsvpCount: 60, rsvped: true }],
  "club-005": [{ id: "e8", title: "Deaf Culture Movie Night", description: "Watching CODA followed by open discussion. Subtitles provided.", date: "2025-03-08", time: "7:00 PM", location: "Student Union Theater", rsvpCount: 35, rsvped: false }],
  "club-006": [
  ...
  "club-007": [{ id: "e11", title: "Formula SAE Technical Review", description: "Full systems review before competition. Open to all members.", date: "2025-03-15", time: "10:00 AM", location: "Engineering Complex Parking", rsvpCount: 18, rsvped: false }],
  "club-008": [
  ...
  "club-010": [{ id: "e16", title: "Open Mic Night: Spring Edition", description: "Share poems, short fiction, or creative nonfiction in a welcoming setting.", date: "2025-03-13", time: "7:00 PM", location: "Oasis Wellness Center",    rsvpCount: 40,  rsvped: false }],
  "club-011": [{ id: "e17", title: "Startup Pitch Night",             description: "10 student startups pitch to a panel of local investors and founders.",    date: "2025-03-18", time: "6:00 PM", location: "Bookstein Hall Auditorium", rsvpCount: 75,  rsvped: false }],
  "club-012": [
...
// BACKEND: SELECT * FROM clubs WHERE id = :id
